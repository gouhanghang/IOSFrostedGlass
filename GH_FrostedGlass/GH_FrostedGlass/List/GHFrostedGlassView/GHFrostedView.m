...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //        _backgroundGlassView.backgroundColor=kYellowColor;
...
change:(NSDictionary *)change context:(void *)context {
    ...
    [self setBlurLevel:(self.scrollView.contentOffset.x + self.scrollView.contentInset.top) / (2 * CGRectGetHeight(self.bounds) / 3)];
}
